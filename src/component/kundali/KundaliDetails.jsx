...
const KundaliDetails = ({ kundaliData }) => {
  ...
  const boyData = [
    { key: "1", label: t('name'), value: kundaliData?.male?.name },
    {
      key: "2",
      label: t('birth_date'),
      // value: LocalLanguage === LanguageOption?.ENGLISH ? formatDate(kundaliData?.male?.dob, DateFormat?.ABBREVIATED_FULL_DATE_FORMAT) : kundaliData?.male?.dob,
      value: kundaliData?.male?.dob,
    },
    {
      key: "3",
