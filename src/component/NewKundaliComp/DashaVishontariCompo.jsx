...
export default function DashaVishontariCompo({ mahaDasha, antarDasha }) {
  ...
  // const dataSourceMahaDasha = mahaDasha?.mahadasha.map((planet, index) => ({
  //   key: index,
  //   label: planet,
  //   start_date: formatDate(index === 0 ? mahaDasha?.dasha_start_date : mahaDasha?.mahadasha_order[index - 1], DateFormat?.DATE_SLASH_FORMAT_SPACE),
  //   end_date: formatDate(mahaDasha?.mahadasha_order[index], DateFormat?.DATE_SLASH_FORMAT_SPACE),
  // }));
