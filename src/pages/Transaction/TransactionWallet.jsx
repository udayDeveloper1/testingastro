      ...
      <section>
        <div className=''>
          <CommonBanner
            ...
            text='' highlight={`${active == '0' ? t('Wallet_Transactions') : t('Payment_Logs')
              }`} />
        </div>
        {/* <KundliStepper /> */}
      </section>
          ...
          <div className='container paddingTop50'>
            <div className='grid gap-6 md:gap-12'>
              ...
              <div className='grid grid-cols-1  sm:grid-cols-3 xl:grid-cols-5  gap-3'>
                ...
                <CustomButton
                  className={`  w-full  border font-semibold text-[16px] leading-[100%] transition-all py-[13px] h-full ${active === '1' ? 'setting_active ' : 'setting_inactive'
                    }`}
                  parentClassName='h-full '
                  onClick={() => {
                    setActive('1')
...
export default memo(TransactionWallet)
